  ...
  return (
    <section className="relative overflow-hidden py-28 sm:py-36 px-6" style={{ background: '#0a1128' }}>
      <svg
        ...
        aria-hidden="true"
      >
        <path d="M0,0 L58,0 C48,35 62,65 46,100 L0,100 Z" fill="rgba(62,198,255,0.05)" />
        <path
          d="M58,0 C48,35 62,65 46,100"
          fill="none"
      ...
      <div className="relative z-10 mx-auto grid max-w-6xl gap-16 md:grid-cols-2 md:gap-8">
        <motion.div
          variants={fadeUp}
          initial="hidden"
          whileInView="show"
